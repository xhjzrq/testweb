  ...
  <div class="app-container">
    <el-container>
      ...
      <el-container>
        ...
        <el-aside style="margin-top: 21px; height:819px; background:white" width="200px">
        ...
        <el-main>
          ...
          <div class="zz">
            ...
            >
              ...
              <el-table-column prop="tribonModule" label="分段" width="80" align="center" />
              <el-table-column prop="pipeNo" label="部件号" width="150" align="center" />

              <el-table-column prop="inTreatment" label="内表面处理" width="90" align="center" />
              <el-table-column prop="outTreatment" label="外表面处理" width="90" align="center" />
              <el-table-column prop="inPaintCode" label="内涂装代码" width="90" align="center" />
              <el-table-column prop="outPaintCode" label="外涂装代码" width="90" align="center" />
              ...
              <el-table-column prop="pipeWeight" label="重量Kg" align="center" />
              ...
              <el-table-column prop="modifyDate" label="修改时间" :show-overflow-tooltip="true" align="center" />
              <el-table-column prop="pipeLineCode" label="生产线编码" align="center" />
            </el-table>
            ...
            >
              ...
              <el-table-column prop="mtrlXHCZ" label="型号材质" align="center" />
              <el-table-column prop="mtrlQuantity" label="数量" align="center" />
              <el-table-column prop="mtrlUnit" label="单位" align="center" />
              <el-table-column prop="mtrlBuildLength" label="制造长度mm" align="center" />
              <el-table-column prop="mtrlWeight" label="重量Kg" align="center" />
            </el-table>
            ...
            >
              ...
              <el-table-column prop="straightPipe" label="直管段" align="center" />
              ...
              <el-table-column prop="accConnection" label="附件连接" align="center" />
            </el-table>
          </div>
        </el-main>
      </el-container>
...
export default {
  ...
  methods: {
    ...
    update(data) {
      ...
      this.$router.push({ name: 'Openpdf', query: { name: data.drawingno, page: data.page, sname: this.input }})
    }
  }
}
</script>
